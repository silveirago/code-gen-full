...
#define N_MUX 0  // number of multiplexers

// Define s0, s1, s2, s3, and x pins
const int mux_s[4] = {  };
const int mux_x[N_MUX] = {  };  // analog pin of the first mux
...
const byte BUTTON_ARDUINO_PIN[N_BUTTONS_ARDUINO] = { 2,3,4 };  // pins of each button connected straight to the Arduino
...
byte MESSAGE_VAL[N_BUTTONS] = { 36,38,42 };
...
byte POT_CC_N[N_POTS] = { 11,12 };  // Add the CC, or PB, NUMBER or MACKIE of each pot you want
...
Encoder encoder[N_ENCODERS] = { {6,5} };  // the two pins of each encoder -  Use pins with Interrupts!

// Choose the CC or MACKIE value
byte ENCODER_CC_N[N_ENCODERS] = { 5 };  // Add the CC NUMBER of each encoder you want
